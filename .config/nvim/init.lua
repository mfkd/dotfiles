...
-- Use Neovim's native completion UI.
...
require('lazy').setup({
  ...
  },
  {
    ...
    dependencies = {
      ...
      -- Mason is used to install and manage LSP servers/tools.
    ...
    config = function()
      ...
      -- With mason-lspconfig installed, mason-tool-installer accepts lspconfig names.
